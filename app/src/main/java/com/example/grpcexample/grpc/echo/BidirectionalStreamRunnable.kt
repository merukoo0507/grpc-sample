...
import com.example.grpcexample.utils.InputRunnable
import io.grpc.stub.StreamObserver
import timber.log.Timber
import java.lang.ref.WeakReference
import java.util.concurrent.CountDownLatch

class BidirectionalStreamRunnable:
    GrpcRunnable {
    ...
    override fun run(blockingStub: EchoGrpc.EchoBlockingStub, asyncStub: EchoGrpc.EchoStub, activityReference: WeakReference<EchoActivity>): String {
        ...
        return serverStream("Bidirectional Stream Test.", asyncStub)
    }

    fun serverStream(msg: String, asyncStub: EchoGrpc.EchoStub): String {
        requestObserver = asyncStub.bidirectionalStreamingEcho(
